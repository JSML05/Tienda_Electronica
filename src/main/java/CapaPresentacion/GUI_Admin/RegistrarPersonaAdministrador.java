...
import CapaLogicaNegocio.Helper.HelperRegistro;
...
public ArrayList<Producto> lsproductos = new ArrayList<>();
    ...
    public void RegistarProducto() {
        ...
        res = CapaLogicaNegocio.Helper.HelperValidacion.ValidarTodo(nombre);
        res1 = CapaLogicaNegocio.Helper.HelperValidacion.ValidarTodo(marca);
        res2 = CapaLogicaNegocio.Helper.HelperValidacion.ValidarTodoSerial(serial);
    ...
    public void RegistrarPersona() {
        ...
        res = CapaLogicaNegocio.Helper.HelperValidacion.ValidarTodo(nombre);
        res1 = CapaLogicaNegocio.Helper.HelperValidacion.ValidarTodo(apellido);
        res2 = CapaLogicaNegocio.Helper.HelperValidacion.ValidarTodoLetra(cedula);
        res3 = CapaLogicaNegocio.Helper.HelperValidacion.ValidarTodoDireccion(direccion);
        res4 = CapaLogicaNegocio.Helper.HelperValidacion.ValidarTodoSerial(nom_img);
        ...
        if (res == 0 && res1 == 0 && res2 == 0 && res3 == 0 && res4 == 0) {
            ...
            objper = new Persona(nombre, apellido, direccion, cedula, producto, String.valueOf(id), nom_img);
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(250, 190, 180, 31);
        ...
        jButton4.setBounds(30, 460, 76, 23);
